<?php
	...
	/*
57. Используя условие задачи №55, создайте класс-потомок. 
В нем объявите общедоступное свойство $price и создайте 
метод product_price(), который аналогичным образом будет 
вычислять общую стоимость всех яблок. После чего выведите 
общее количество корзин, массу и стоимость всех яблок на экран.
	*/
